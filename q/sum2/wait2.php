...
<?php
$sqlminute = "SELECT time_wait,time_start,dep_station from kskdepartment_plk where depcode = '$depcode2'";
...
while ($result2 = mysqli_fetch_array($query2, MYSQLI_ASSOC)) {
  ...
  WHERE vn='$vn'";
    ...
    <div class="q-rows-purple pad-5">
        <div class="rowlist text-center" style="flex:0.5;"><?= $counter + 1; ?></div>
        <div class="rowlist text-center" style="flex:1.3;"><span class="bg-purple padding-q em100"><?= $result2["depq"]; ?></span></div>
