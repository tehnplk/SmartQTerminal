...
while ($result2 = mysqli_fetch_array($query2, MYSQLI_ASSOC)) {
  ...
  WHERE vn='$vn'";
    ...
    ?>
    <div class="q-rows-blue pad-5">
        <div class="rowlist text-center" style="flex:1.3;"><span class="bg-blue padding-q em100"><?= $result2["depq"]; ?></span></div>
        <div class="rowlist text-left text-black" style="flex:4.5;"><?= $result2["newname"]; ?></div>
