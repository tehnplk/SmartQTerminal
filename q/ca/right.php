...
while ($result2 = mysqli_fetch_array($query2, MYSQLI_ASSOC)) {
  ...
  WHERE vn='$vn'";
    ...
    <div class="q-rows-blue pad-5">
        ...
        <div class="rowlist text-center" style="flex:1.5;"><span class="padding-q bg-blue em100"><?= $result2["depq"]; ?></span></div>
        <div class="rowlist text-left" style="flex:5;"><?= $result2["newname"]; ?></div>
    </div>
    <?php
    $counter++;
}
